...
class OCREngine(ABC):
    ...
    @abstractmethod
    def recognize(self, image: np.ndarray, lang: str = "ita+eng") -> List[OCRResult]:
        """Perform OCR on an image, return list of results."""
        pass
    
    @abstractmethod
    def recognize_text(self, image: np.ndarray, lang: str = "ita+eng") -> str:
...
class OCRManager:
    ...
    def extract_words(self, image: np.ndarray) -> List[Tuple[str, Tuple[int, int, int, int]]]:
